...
namespace simple_erp.Testes.Modulos.Estoque.Repositories
{
    ...
    /// Estoque. Cria o schema do modelo EF e trunca as tabelas entre testes. Requer
    /// Docker; as classes que a usam levam [Trait("Categoria","Integracao")].
    /// </summary>
    public sealed class PostgresEstoqueFixture : IAsyncLifetime
    {
        ...
        public async Task LimparAsync()
        {
            ...
            await contexto.Database.ExecuteSqlRawAsync(
                "TRUNCATE TABLE estoque.saldos, estoque.movimentacoes");
        }
    }
}
