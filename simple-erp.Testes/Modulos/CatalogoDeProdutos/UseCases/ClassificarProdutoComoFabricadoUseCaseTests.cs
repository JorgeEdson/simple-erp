...
namespace simple_erp.Testes.Modulos.CatalogoDeProdutos.UseCases
{
    public sealed class ClassificarProdutoComoFabricadoUseCaseTests
    {
        ...
        {
            // Arrange
            var entrada = new ClassificarProdutoComoFabricadoEntrada(Guid.Empty);
        ...
        {
            // Arrange
            var entrada = new ClassificarProdutoComoFabricadoEntrada(new Guid("00000000-0000-0000-0000-000000123456"));
        ...
        public async Task ExecutarAsync_DeveRetornarFalha_QuandoProdutoEstiverInativo()
        {
            ...
            var entrada = new ClassificarProdutoComoFabricadoEntrada(produto.Id);
