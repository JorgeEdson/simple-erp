...
namespace simple_erp.Testes.Modulos.CatalogoDeProdutos.UseCases
{
    public sealed class InativarProdutoUseCaseTests
    {
        ...
        {
            // Arrange
            var entrada = new InativarProdutoEntrada(Guid.Empty);
        ...
        {
            // Arrange
            var entrada = new InativarProdutoEntrada(new Guid("00000000-0000-0000-0000-000000123456"));
        ...
        public async Task ExecutarAsync_DeveRetornarFalha_QuandoAtualizarFalhar()
        {
            ...
            var entrada = new InativarProdutoEntrada(produto.Id);
