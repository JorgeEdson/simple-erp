...
namespace simple_erp.Testes.Modulos.Suprimentos.Repositories
{
    ...
    {
        private static readonly Guid IdFornecedor = new Guid("00000000-0000-0000-0000-202607210002");
        ...
        public async Task AdicionarEObterPorId_DevePersistirOsItensEmJsonb()
        {
            var pedido = PedidoDeCompraBuilder.Novo()
                .ComId(new Guid("00000000-0000-0000-0000-202607210800"))
                .ComIdFornecedor(IdFornecedor)
                .SemItens() // limpa o item padrão do builder para partir do zero
                .ComItem(new Guid("00000000-0000-0000-0000-202607210010"), quantidade: 5m, custoUnitario: 2.50m)
                .ComItem(new Guid("00000000-0000-0000-0000-202607210011"), quantidade: 3m, custoUnitario: 4.00m)
                .EmEdicao()
                .Criar();
            ...
            var recuperado = (await new PedidoDeCompraRepository(contexto)
                .ObterPorIdAsync(IdDe(new Guid("00000000-0000-0000-0000-202607210800")))).Instancia;

            recuperado.Should().NotBeNull();
            recuperado!.IdFornecedor.Should().Be(IdFornecedor);
            recuperado.Status.Should().Be(StatusPedidoDeCompra.EmEdicao);
            recuperado.Itens.Should().HaveCount(2);

            var primeiro = recuperado.Itens.Single(i => i.IdProduto == new Guid("00000000-0000-0000-0000-202607210010"));
        ...
        public async Task EditarItens_ViaEntidadeRastreada_DevePersistirAsAlteracoesDaColecao()
        {
            await SalvarAsync(PedidoDeCompraBuilder.Novo()
                .ComId(new Guid("00000000-0000-0000-0000-202607210810")).ComIdFornecedor(IdFornecedor)
                .SemItens() // limpa o item padrão do builder para partir do zero
            ...
            {
                var repositorio = new PedidoDeCompraRepository(contexto);
                var pedido = (await repositorio.ObterPorIdAsync(IdDe(new Guid("00000000-0000-0000-0000-202607210810")))).Instancia!;
            ...
            var recuperado = (await new PedidoDeCompraRepository(contextoLeitura)
                .ObterPorIdAsync(IdDe(new Guid("00000000-0000-0000-0000-202607210810")))).Instancia!;
        ...
        {
            await SalvarAsync(PedidoDeCompraBuilder.Novo()
                .ComId(new Guid("00000000-0000-0000-0000-202607210820")).ComIdFornecedor(IdFornecedor)
                .ComItem(new Guid("00000000-0000-0000-0000-202607210010"), 2m, 5m)
                .EmEdicao().Criar());

            await using (var contexto = _fixture.CriarContexto())
            {
                var repositorio = new PedidoDeCompraRepository(contexto);
                var pedido = (await repositorio.ObterPorIdAsync(IdDe(new Guid("00000000-0000-0000-0000-202607210820")))).Instancia!;
            ...
            await using var contextoLeitura = _fixture.CriarContexto();
            var recuperado = (await new PedidoDeCompraRepository(contextoLeitura)
                .ObterPorIdAsync(IdDe(new Guid("00000000-0000-0000-0000-202607210820")))).Instancia!;
        ...
        {
            await SalvarAsync(
                PedidoDeCompraBuilder.Novo().ComId(new Guid("00000000-0000-0000-0000-202607210830")).ComIdFornecedor(IdFornecedor)
                    .ComItem(new Guid("00000000-0000-0000-0000-202607210010"), 1m, 1m).EmEdicao().Criar(),
                PedidoDeCompraBuilder.Novo().ComId(new Guid("00000000-0000-0000-0000-202607210831")).ComIdFornecedor(IdFornecedor)
                    .ComItem(new Guid("00000000-0000-0000-0000-202607210010"), 1m, 1m).Aprovado().Criar(),
                PedidoDeCompraBuilder.Novo().ComId(new Guid("00000000-0000-0000-0000-202607210832")).ComIdFornecedor(new Guid("00000000-0000-0000-0000-202607219999"))
                    .ComItem(new Guid("00000000-0000-0000-0000-202607210010"), 1m, 1m).EmEdicao().Criar());
