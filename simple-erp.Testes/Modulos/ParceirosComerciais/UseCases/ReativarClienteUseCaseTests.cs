...
namespace simple_erp.Testes.Modulos.ParceirosComerciais.UseCases
{
    public sealed class ReativarClienteUseCaseTests
    {
        ...
        {
            // Arrange
            var entrada = new ReativarClienteEntrada(Guid.Empty);
        ...
        {
            // Arrange
            var entrada = new ReativarClienteEntrada(new Guid("00000000-0000-0000-0000-000000123456"));
        ...
        public async Task ExecutarAsync_DeveRetornarFalha_QuandoAtualizarFalhar()
        {
            ...
            var entrada = new ReativarClienteEntrada(cliente.Id);
